...
try:
    ...
    print("⚠️ Error loading trusted domains:", e)
# ================================
...
def highlight_url(url):
    ...
    while i < len(url):
        ...
        if c in ["@", "-"]:
            ...
            highlighted += (
                f"<span style='color:red;font-weight:bold'>{c}</span>"
            )
    ...
    try:
        ...
        # 🤖 ML DETECTION
            ...
            if ml_pred == 1:
                ...
                reasons.append(
                    "ML model detected phishing pattern"
                )
